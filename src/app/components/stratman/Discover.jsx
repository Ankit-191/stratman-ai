...
const Discover = () => {
  return (
    <div className="bg-box-image bg-repeat bg-cover bg-center bg-dark-black xl:px-0 mx-3 sm:mx-5 py-[50px] sm:py-[80px] lg:py-[100px] rounded-[16px] sm:rounded-[25px] lg:rounded-[40px] px-3 " >
