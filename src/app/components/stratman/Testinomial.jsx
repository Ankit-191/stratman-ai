  ...
  return (
    <div className="bg-blue-image bg-cover bg-center mx-3 sm:mx-5 rounded-[16px] sm:rounded-[25px] lg:rounded-[40px] py-[50px] sm:py-[80px] pb-[90px] lg:py-[100px]">
      <div className="container max-w-[1164px] mx-auto px-3 relative">
        ...
        <h2 className="font-anekTelegu font-semibold text-white text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[120%]">
          Trusted <span className="font-extralight">investors &</span>{" "}
          <span className="text-blue">organizations</span>{" "}
        </h2>
        <p className="text-light-white text-sm sm:font-base font-normal font-openSans leading-[150%] max-w-[812px] text-center mx-auto pb-4 sm:pb-6 md:pb-9 lg:pb-[60px]">
          ...
          {organizationData.map((data, i) => (
            <SwiperSlide key={i}>
              <div className="bg-dark-blue md:max-w-[364px] rounded-[14px] pb-0 p-3 sm:p-6 swiper-card min-h-[212px] sm:min-h-[252px] h-full">
                <p className="sm:text-base text-sm font-normal text-lightBlack font-openSans border-b-[2px] border-[#BBD5E7] pb-2 sm:pb-4 leading-[150%] min-h-[120px] sm:min-h-[137px] testimonials_slider">
                  {data.Para}
                </p>
                <div className="flex items-center pt-4">
                  ...
                  <div className="flex justify-between items-center w-full">
                    <div className="ps-3">
                      <p className="sm:pb-1 text-sm sm:text-lg font-semibold font-openSans leading-[150%]">
                        {data.Name}
                      </p>
                      <p className="text-black text-base font-openSans font-normal leading-[150%]">
                        {data.Profession}
                      </p>
                    </div>
                    <div>{data.Collen}</div>
