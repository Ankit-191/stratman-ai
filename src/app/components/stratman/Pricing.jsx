...
const Pricing = () => {
  return (
    <div
      className="max-w-[1164px] xl:py-[140px] lg:py-[100px] md:py-20 sm:py-16 py-12 px-3 mx-auto"
      id="pricing"
    >
      ...
      <div className="flex flex-row flex-wrap justify-center -mx-3 mt-6 md:mt-12 pt-3">
        {PricingData.map((obj, index) => (
          <div key={index} className="w-full max-w-[400px] sm:w-6/12 lg:w-4/12 px-3">
