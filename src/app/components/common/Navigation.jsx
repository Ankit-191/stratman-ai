    ...
    <>
      <div className="container max-w-[1164px] mx-auto px-3 py-[19px]">
        <div className="flex items-center justify-between">
          ...
          <ul
            className={`flex gap-8 flex-col lg:flex-row text-center lg:text-start fixed z-[9] lg:sticky w-full lg:w-auto bg-black lg:bg-transparent start-[-100%] top-0 h-screen lg:h-auto justify-center transition-all duration-300 ease-in-out ${
              handleNav ? "!start-0" : ""
            }`}
          >
              ...
              return (
                <li key={index}>
                  <Link
                    ...
                    className={`text-xl lg:text-base hover:text-blue transition-all opacity-70 duration-300 ease-in-out ${
